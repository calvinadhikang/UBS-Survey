...
<body>
	...
	<nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl " id="navbarBlur" data-scroll="false">
		<div class="container-fluid py-1 px-3">
			...
			<h3 class="font-weight-bolder text-white mb-0">Master Pertanyaan</h3>
			</nav>
		</div>
    </nav>
    <div class="container-fluid py-4">
      <div class="row">
        <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
			<div class="container-fluid py-1 px-3">
				<nav aria-label="breadcrumb">
				<h3 class="font-weight-bolder text-white mb-0">Tabel Pertanyaan</h3>
				</nav>
			</div>
        </div>
    </div>
                ...
                <table class="table align-items-center mb-0">
                  ...
                  <tbody>
                    <tr>
						...
						<td>
							<span class="text-secondary text-xs font-weight-bold">Apakah divisi sudah bagus?</span>
						</td>
                    ...
                    <tr>
						...
						<td>
							<span class="text-secondary text-xs font-weight-bold">Apakah divisi sudah berjalan sesuai aturan?</span>
						</td>
						<td class="align-middle text-center">
							<button class="btn btn-primary">Update</button>
							<button class="btn btn-danger">Delete</button>
                    ...
                    <tr>
						...
						<td>
							<span class="text-secondary text-xs font-weight-bold">Berapa nilai kepuasan untuk divisi ini?</span>
						</td>
						<td class="align-middle text-center">
							<button class="btn btn-primary">Update</button>
							<button class="btn btn-danger">Delete</button>
                    ...
                    <tr>
						...
						<td>
							<span class="text-secondary text-xs font-weight-bold">Berapa nilai kekompakkan divisi ini?</span>
						</td>
						<td class="align-middle text-center">
							<button class="btn btn-primary">Update</button>
							<button class="btn btn-danger">Delete</button>
                    ...
                    <tr>
						...
						<td>
							<span class="text-secondary text-xs font-weight-bold">Apakah divisi ini mengalami banyak masalah?</span>
						</td>
						<td class="align-middle text-center">
							<button class="btn btn-primary">Update</button>
							<button class="btn btn-danger">Delete</button>
